...
if __name__ == "__main__":
    ...
    # 过滤 ====>  也可以使用'~'或者'-'来选择不在列表中的项
    id_not_in_stu = student[~student["ID"].isin([116, 117])]
    logger.logger.info("过滤 ===> 使用'~'或者'-'来选择不在列表中的项 查询学生不在 116 和117中的学生信息:{} \n".format(id_not_in_stu))
...
过滤 ===> 查询学生id是45 和58的学生信息:   ID  SNO   SNAME SSEX          createDate updateDate remark
1  45  333  名称5add    F 2023-01-25 17:59:07        NaT     测试
2  58   10  测试新增前端    F 2023-03-30 11:30:00        NaT     备注 



使用'~'或者'-'来选择不在列表中的项 查询学生不在 116 和117中的学生信息:    ID     SNO   SNAME SSEX          createDate          updateDate remark
0   43  659625     名称3    男 2023-02-25 17:59:07                 NaT   测试01
1   45     333  名称5add    F 2023-01-25 17:59:07                 NaT     测试
2   58      10  测试新增前端    F 2023-03-30 11:30:00                 NaT     备注
3  102  string  string    F 2023-01-03 09:59:02 2023-01-03 08:59:47   None 
